document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".i-o-navigation-list");
  const headerRef = document.querySelector(".i-o-header");
  const navigationRef = document.querySelector(".i-o-navigation");
  ...
  document.querySelectorAll(".i-o-navigation-link").forEach((n) =>
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".i-o-toggle-button img");
